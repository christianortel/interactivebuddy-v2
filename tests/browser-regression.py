...
def run(url):
    ...
    with sync_playwright() as p:
        ...
        assert_true({"juggle", "tether", "liquid", "props", "bead", "suction", "spin", "spark", "frost", "goo", "pulse", "cheer", "groove", "bonus", "export"}.issubset(set(initial["challengeOptions"])), "Challenge options should include new modes")
        ...
        assert_true(initial["roomPreviewPack"] == "base" and initial["roomPreviewName"] == "Classic Plain", "Room preview should describe the default room pack")
        assert_true(initial["roomPreviewMotif"] == "plain", "Base room preview should expose a motif-aware thumbnail")
        assert_true(initial["roomPreviewSwatches"] == 4, "Room preview should show four palette swatches")
        assert_true(any("#9aa59d" in color for color in initial["roomPreviewColors"]), "Base room preview should expose the background color")
        assert_true(initial["roomBrowserActive"] == "base", "Room browser should default to Classic Plain")
        ...
        assert_true({"plain", "neon", "office", "arcade", "desktop", "workshop", "dojo"}.issubset(set(initial["roomBrowserThumbnails"])), "Room browser should render motif thumbnails for built-in room packs")
